...
public class ParcialArboles {	 
	 public static boolean esDeSeleccion (GeneralTree<Integer> arbol) {
		 if (arbol.isLeaf() | arbol.isEmpty() | arbol == null) {
			 return true;
		 }
		 else {
			 ...
			 while (it.hasNext() && seleccion) {
				 ...
				 menor = Math.min(menor, child.getData());
				 seleccion = seleccion && esDeSeleccion(child);
			 }
			 return seleccion && menor == arbol.getData();
		 }
	 }
	 ...
	 public static void main(String[] args) {
	        ...
	        System.out.println("¿Es de seleccion? " + esDeSeleccion(a));
	    }
}
